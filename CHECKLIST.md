...
- [x] Measure live latency separately when available; report misses rather than fabricating targets (2026-09-11 OpenRouter returned invalid structured output after 3.09 s; on 2026-09-12 Gemini listed `gemini-3.8-flash`, but five extraction attempts and a minimal structured request returned HTTP 429 quota exhaustion in 1.0–1.6 s).
